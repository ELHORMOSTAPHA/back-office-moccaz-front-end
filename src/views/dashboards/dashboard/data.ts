import { TbTruck, TbRoute, TbUsers, TbClipboardList } from 'react-icons/tb'
...
export const totalSalesChart: () => ChartJSOptionsType = () => ({
  type: 'doughnut',
  data: {
    labels: ['Transport National', 'Transport International', 'Livraison Express', 'Stockage'],
    datasets: [
      {
        label: '2024',
        data: [450, 280, 150, 120],
...
const transportNational = generateRandomData(800, 1200)
const transportInternational = generateRandomData(600, 1000)

const totalTrajets = generateRandomData(2000, 3000)
