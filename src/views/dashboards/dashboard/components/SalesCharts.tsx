        ...
        <Row className="g-0">
          <Col xxl={3} xl={6} className="order-xl-1 order-xxl-0">
            <div className="p-3 border-end border-dashed">
              <h4 className="card-title mb-0">Répartition Services</h4>
              <p className="text-muted fs-xs">Vous avez 21 demandes en attente de traitement.</p>
