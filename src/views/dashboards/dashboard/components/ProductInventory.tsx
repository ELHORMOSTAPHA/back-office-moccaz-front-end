        ...
        <Card>
            <CardHeader className="justify-content-between align-items-center border-dashed">
                ...
                <div className="d-flex gap-2">
                    <Link to="/menu/vehicules" >
                        <Button variant="soft-secondary" size="sm">
                            <TbPlus className="me-1"/> Ajouter Véhicule
                        </Button>
                    </Link>
                    <Button variant="primary" size="sm">
                        <TbFileExport className="me-1"/> Exporter CSV
                    </Button>
                </div>
            </CardHeader>
            <CardBody className="p-0">
                <DataTable<ProductType> table={table} emptyMessage="Aucun enregistrement trouvé" showHeaders={false}/>
            </CardBody>
