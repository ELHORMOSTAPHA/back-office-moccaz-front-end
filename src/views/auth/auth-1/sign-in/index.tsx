...
import {Button, Card, Col, Container, Form, FormControl, FormLabel, Row, Alert} from 'react-bootstrap'
import eurofastBg from '@/assets/images/eurofast-login-bg.jpg'
...
const Index = () => {
  ...
  const mutation = useMutation({
    ...
    onSuccess: (data) => {
      ...
      setUser(data.user)
      // Redirect to tableau-de-bord after successful login
      navigate('/dashboard');
    },
    onError: (error: any) => {
