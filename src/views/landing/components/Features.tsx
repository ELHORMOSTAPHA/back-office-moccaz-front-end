      ...
      <Container>
        <Row>
          <Col xs={12} className="text-center">
            ...
            <h2 className="mt-3 fw-bold mb-5">Discover the Core <span className="text-primary">Features</span> of EUROFAT</h2>
          </Col>
        </Row>
        <Row className="align-items-center pb-5">
          ...
          <Col lg={5} className="ms-auto py-3">
            <h3 className="mb-3 fs-xl lh-base">Powering Smart Admin Experiences with EUROFAT</h3>
            <p className="mb-2 lead">EUROFAT is a feature-rich, high-performance admin dashboard template built for modern web applications and enterprise-grade interfaces.</p>
        ...
        <Row className="align-items-center">
          <Col lg={5} className="py-3 order-2 order-lg-1">
            ...
            <p className="mb-2 lead">EUROFAT empowers admins with a smart, responsive interface to manage users, analytics, content, and workflows effortlessly.</p>
            ...
            <Link to="/" className="btn btn-primary mb-4">Explore EUROFAT Admin</Link>
