            ...
            <div className="p-4">
              ...
              <div className="d-flex gap-3 mb-4">
                ...
                <div>
                  ...
                  <h5 className="my-2">info@EUROFAT.com</h5>
                  <h5 className="mb-0">support@EUROFAT.com</h5>
                </div>
              </div>
              <div className="d-flex gap-3">
                ...
                <div>
                  ...
                  <h5 className="my-1 lh-lg">EUROFAT HQ, 500 Innovation Drive, Suite 200, Metropolis, NY 10101, USA</h5>
                </div>
              </div>
            </div>
          </Col>
