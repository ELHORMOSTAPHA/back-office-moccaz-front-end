      ...
      <Container>
        <Row className="g-4 justify-content-between">
          <div className="col-lg-3">
            ...
            <p className="mt-3 fs-sm">
              EUROFAT is a best-selling admin dashboard template on ThemeForest, recognized for its clean design, versatility, and robust features. Create modern, responsive web applications effortlessly with this top-tier solution!
            </p>
        ...
        <Row className="mt-5">
          <Col xs={12} className="text-center">
            <p className="mb-4">© {currentYear} EUROFAT By <span className="fw-semibold">CONEXUS IT SOLUTIONS</span> </p>
          </Col>
        </Row>
