...
const Index = () => {
  ...
  return (
    <Container fluid>
      <PageBreadcrumb title="Gestion des profils" subtitle="paramètres" />
      ...
      <Modal show={show} onHide={toggle} className="fade" dialogClassName='modal-lg' id="editRoleModal" tabIndex={-1} aria-labelledby="editRoleModalLabel" aria-hidden="true">
        <ModalHeader>
          <h5 className="modal-title" id="editRoleModalLabel">Modifier le profil</h5>
        ...
        <form id="editRoleForm">
          <ModalBody>
            <Row className="g-3">
              <Col md={6}>
                <FormLabel htmlFor="editRoleName">Nom du profil</FormLabel>
              ...
              <Col md={6}>
                <FormLabel htmlFor="editRoleIcon">Icône du profil</FormLabel>
