...
export const menuItems: MenuItemType[] = [
  { key: 'navigation', label: 'Accueil', isTitle: true },
  { key: 'dashboards', label: 'Tableau de bord', icon: LuCircleGauge, url: '/dashboard' },
  // {
  //   key: 'dashboards',
  //   label: 'Dashboards',
  //   icon: LuCircleGauge,
  ...
  // { key: 'stock', label: 'stock', icon: MdOutlineSchedule, url: '/planification' },
  // { key: 'demandes vin', label: 'demandes vin', icon: MdOutlineTaskAlt, url: '/missions' },
  // { key: 'depots', label: 'depots', icon: MdOutlineHelpOutline, url: '/demande' },
  // { key: 'historique', label: 'historique', icon: MdOutlinePublic, url: '/trajets' },
  {key:'clients', label: 'clients', icon: TbUsers, url: '/clients' },
  { key: 'annonces', label: 'annonces', icon: MdOutlineAssignmentInd, url: '/announces' },
  { key: 'boutiques', label: 'boutiques', icon: MdOutlineAssignmentInd, url: '/boutiques' },
  // { key: 'depots', label: 'depots', icon: MdOutlineDirectionsCar, url: '/depots' },
  // { key: 'historique', label: 'historique', icon: LuCalendar, url: '/historique' },
  // // {key:'livraison', label: 'livraison', icon: LuShoppingBag, url: '/livraison' },
  ...
  { key: 'custom', label: 'Parametres', isTitle: true },
  // { key: 'voyages', label: 'Voyages', icon: LuShoppingBag, url: '/voyages' },
  { key: 'users-management', label: 'Gestion des utilisateurs', icon: MdOutlineAdminPanelSettings, url: '/parametres/utilisateurs' },
  { key: 'profiles-management', label: 'Gestion des profiles', icon: MdOutlineSettings, url: '/parametres/Profiles' },
...
export const menuItems2: MenuItemType[] = [
  { key: 'menu', label: 'Menu', isTitle: true },
  { key: 'client-dashboard', label: 'Tableau de bord', icon: LuCircleGauge, url: '/tableau-de-bord' },
  { key: 'Historique', label: 'Mes demandes', icon: LuShoppingBag, url: '/historique_demande' },
